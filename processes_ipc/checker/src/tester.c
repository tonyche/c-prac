...
int main(int argc, char **argv) {
    ...
    if (p_checker > 0) {
        ...
        if (amount_of_correct == num_of_ques) {
            ...
            printf("Your result is: %d\n/%" PRIu16 "", amount_of_correct, num_of_ques);
        }
